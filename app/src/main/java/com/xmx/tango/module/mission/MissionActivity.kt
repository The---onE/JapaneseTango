            ...
            if (part.isNotBlank()) {
                if (part.contains(TangoConstants.VERB_FLAG)) {
                    ...
                    tango?.apply {
                        ...
                        var type = 0
                        when (this.partOfSpeech) {
                            TangoConstants.VERB1_FLAG -> type = 1
                            TangoConstants.VERB2_FLAG -> type = 2
                            TangoConstants.VERB3_FLAG -> type = 3
                        }
                        // 显示动词变形对话框
